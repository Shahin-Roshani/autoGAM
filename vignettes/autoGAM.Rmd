...
In this vignette, we propose two different examples on well-known datasets and we try to cover all different aspects of arguments and outputs of this all-in-one function through them.
...
Finally, last but not least, the fitted best GAM fitted with the final predictors:
